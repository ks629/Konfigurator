...
import { CreditCard, ArrowLeft, Clock, Check, Shield, Lock } from 'lucide-react';
    ...
    <div className="nexbe-dark dark min-h-screen flex flex-col bg-[#0f0520]">
      ...
      <main className="flex-1 relative">
        ...
        <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
          ...
          {/* Order Progress Bar */}
          <OrderProgressBar currentStep={3} paymentLabel="Płatność zaliczki" />
          ...
          >
            <motion.div variants={fadeUp} className="rounded-2xl border border-white/10 bg-[#1A0A2E]/80 backdrop-blur-sm p-8 space-y-6 text-center">
              <motion.div
                ...
                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#B5005D] to-[#FF004E] flex items-center justify-center mx-auto"
              >
