...
describe('roundToNearestCapacity', () => {
  test('should round to nearest available capacity', () => {
    expect(roundToNearestCapacity(4)).toBe(5);
    expect(roundToNearestCapacity(6)).toBe(5);
    expect(roundToNearestCapacity(8)).toBe(7);
    expect(roundToNearestCapacity(11)).toBe(10);
    expect(roundToNearestCapacity(13)).toBe(12);
    expect(roundToNearestCapacity(17)).toBe(15);
    expect(roundToNearestCapacity(25)).toBe(20);
  });

  test('should return exact match for available capacities', () => {
    expect(roundToNearestCapacity(5)).toBe(5);
